...
var colors__namespace = /*#__PURE__*/_interopNamespace(colors$1);
var helpers__namespace = /*#__PURE__*/_interopNamespace(helpers$1);
 ...
 */
class Node extends tuiEvents.EventEmitter {
  /**
   * Node
   */
  constructor(options) {
...
class Screen extends Node {
  constructor(_options) {
    ...
    if (!this.program) {
      this.program = tuiProgram.Program.build({
