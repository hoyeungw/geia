...
function charWidth(str, i) {
  const point = typeof str !== 'number' ? codePointAt(str, i || 0) : str; // nul
...
export { charWidth, chars, codePointAt, combining, combiningTable, fromCodePoint, isCombining, isSurrogate, strWidth };
