 ...
 */
export function charWidth(str, i) {
...
export function isSurrogate(str, i) {
  const point = typeof str !== 'number'
    ? codePointAt(str, i || 0)
    : str
...
export const combining = combiningTable.reduce(function (out, row) {
...
export function isCombining(str, i) {
  const point = typeof str !== 'number'
    ? codePointAt(str, i || 0)
    : str
 ...
 * Code Point Helpers
 */
export function codePointAt(str, position) {
  if (str == null) {
    throw TypeError()
  }
